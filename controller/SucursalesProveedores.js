...
export class SucursalesProveedores {
    ...
    actualizar(id, body) {
        conexion.query(/*sql*/ `UPDATE sucursal_proveedor SET ? WHERE id = ?`, [body, id], (err, data, fields) => {
            console.log(err);
            console.log(data);
            console.log(fields);
        });
    ...
    eliminar(id) {
        conexion.query(/*sql*/ `DELETE FROM sucursal_proveedor WHERE id = ?`, [id], (err, data, fields) => {
            console.log(err);
            console.log(data);
            console.log(fields);
        });
