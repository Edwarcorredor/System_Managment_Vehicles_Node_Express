...
export class Empresas {
    ...
    set guardar(body) {
        conexion.query(/*sql*/ `INSERT INTO empresa SET ?`, body, (err, data, fields) => {
            console.log(err);
            console.log(data);
            console.log(fields);
        });
    ...
    actualizar(id, body) {
        conexion.query(/*sql*/ `UPDATE empresa SET ? WHERE id = ?`, [body, id], (err, data, fields) => {
            console.log(err);
            console.log(data);
            console.log(fields);
        });
    ...
    eliminar(id) {
        conexion.query(/*sql*/ `DELETE FROM empresa WHERE id = ?`, [id], (err, data, fields) => {
            console.log(err);
            console.log(data);
            console.log(fields);
        });
